...
const BOOK_ONLINE_LINKS = {
  ...
  walkingtours: 'https://www.kkday.com/en-sg/category/sg-singapore/walking-tours/list?cid=26927&ud1=WalkingTours',
...
const CHIP_I18N = {
  ...
  walkingtours: { en: 'Walking Tours', zh: '徒步导览', ms: 'Lawatan Berjalan Kaki', ta: 'நடைபயண சுற்றுலா', ja: 'ウォーキングツアー', ko: '워킹 투어' },
